...
==============================================================================
phpBBforum Integration module (C) 2007-2013 by Vadim G.B. (http://vgb.org.ru)
==============================================================================
...
1.1. Installing phpbbdrupalbridge MOD with AutoMOD
  ...
  1) Download the phpbbdrupalbridge-3.0.11.zip MOD from http://phpbb.drupalbridge.org/download;
  2) In phpBB ACP go to tab AUTOMOD and upload phpbbdrupalbridge-3.0.11.zip MOD or
     Unpack the phpbbdrupalbridge-3.0.11.zip archive and copy it to the /phpBB3/store/mods/ directory.
  3) In phpBB ACP AUTOMOD tab press Intall.

1.2. Manual phpbbdrupalbridge MOD installation

  1) Download the phpbbdrupalbridge-3.0.11.zip MOD from http://phpbb.drupalbridge.org/download;
  2) Unpack the phpbbdrupalbridge-3.0.11.zip archive directory.
  3) Copy directory and files according instructions in install_phpbb.xml and the scheme below.
   
  +/root ---------------------> +(phpBB root path: /home/vb/example.com/phpBB3/)
    +/images -------------------> +/images (/home/vb/example.com/images)
    ...
    functions_user-embed-3.0.11.patch  --> +/phpBB3/functions_user-embed-3.0.11.patch
    (for functions_user.php only)
    phpBB-embed-3.0.11.patch ------------> +/phpBB3/phpBB-embed-3.0.11.patch
    (for the whole phpBB including patch for functions_user.php)

  4) Apply patch to phpBB
    
    1. If you do not want to use embedded mode "In the Drupal page", you should apply functions_user-embed-3.0.11.patch only

    copy ... root/functions_user-embed-3.0.11.patch  to  .../phpBB3/functions_user-embed-3.0.11.patch
    
    2. If you want to use embedded mode, you should apply phpBB-embed-3.0.11.patch
 
    The patch is made from clean phpBB3-3.0.11.
...
1. Download the phpBBforum module from http://drupal.org/project/phpbbforum
  ...
  Module -------------------------> Your site paths
                                     (Drupal base path: /home/vb/example.com)
+/phpbbforum ----------------------> +/sites/all/modules/phpbbforum
                                     (phpBB root path: /home/vb/example.com/phpBB3/)
